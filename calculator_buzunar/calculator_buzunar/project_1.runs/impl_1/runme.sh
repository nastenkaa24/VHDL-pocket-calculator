...
HD_PWD='C:/Users/Nastenka/Desktop/calculator complet/project_1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculator_buzunar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculator_buzunar.tcl -notrace
