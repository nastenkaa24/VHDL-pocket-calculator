...
HD_PWD='C:/Users/Nastenka/Desktop/calculator complet/project_1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calculator_buzunar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calculator_buzunar.tcl
